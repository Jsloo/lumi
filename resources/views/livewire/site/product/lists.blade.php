<div>
    ...
    <div class="shop-area pt-[50px] pb-[100px]">
        <div class="container">
                    ...
                    <div class="w-3/12 sm:w-full flex-[0_0_auto] max-w-full px-[12px]">
                        <div class="single-product-wrap text-center group">
                            <div class="product-img relative">
                                ...
                                <img src="{{ secure_asset('storage/' . $product->image) }}" alt="product" class="img-fluid w-full" /></a>
                            </div>
                            <div class="product-content p-[20px_0]">
                                <h4>
                                    <a href="#" class="product-title text-[18px] leading-[28px] font-bold capitalize">
                                        {{ $product->name }}
                                    </a>
                                </h4>
                                <div class="product-price text-[14px] leading-[22px] font-normal mx-0 my-2.5 font-OpenSans text-gray-500">
                                    RM {{ $product->price }}
                                </div>
                                <a href="#" wire:click.prevent="enquire({{ $product->id }})"
                                    class="text-[#222222] text-[13px] font-semibold tracking-[1px] leading-[19px] uppercase px-4 py-2 border-0 font-OpenSans inline-block rounded-md btn-type-3 mt-[5px]">
                                    Enquire
                                </a>
            ...
            <x-site.pagination :items="$products" />
        </div>
    </div>
    <!-- shop area end -->
