        ...
        <div class="container">
            ...
            <div class="flex flex-wrap mx-[-12px]">
                @forelse ($categories as $category)
                    <a href="{{ route('category.subcategory',$category->slug) }}">
                        <div class="w-3/12 sm:w-full flex-[0_0_auto] max-w-full px-[12px]">
                            <div class="single-product-wrap text-center group">
                                <div class="product-img relative">
                                    
                                    <img src="{{ secure_asset('storage/' . $category->image) }}" alt="product" class="img-fluid w-full" />
                                    
                                </div>
                                <div class="product-content p-[20px_0]">
                                    <h4><a href="#" class="product-title text-[16px] leading-[26px] font-medium capitalize">{{ $category->name }}</a></h4>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <x-site.pagination :items="$categories" />
        </div>
    </div>
    <!-- shop area end -->
